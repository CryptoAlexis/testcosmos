...
window.onload = async () => {
    ...
    // Force memo to not be changed on the sign screen.
...
document.sendForm.onsubmit = () => {
    ...
    (async () => {
        ...
        const result = await client.delegateTokens(accounts[0].address, recipient, amountFinal, fee, "My super memo")
        // Tranfer transaction.
        // const result = await client.sendTokens(accounts[0].address, recipient, [amountFinal], fee, "My super memo")
